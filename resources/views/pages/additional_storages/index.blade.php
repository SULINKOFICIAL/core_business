...
@section('title', 'Armazenamento adicional')

@section('content')
<div class="card mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-end mb-5">
            <a href="{{ route('additional.storages.create') }}" class="btn btn-primary">Novo item</a>
        </div>
            ...
            <tbody>
                @forelse($items as $item)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{ route('additional.storages.edit', $item->id) }}" class="btn btn-sm btn-icon btn-light-primary">
