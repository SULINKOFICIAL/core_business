    ...
    <div class="card-body">
        <div class="d-flex flex-stack flex-wrap mb-5">
            <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                ...
                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Procurar usuários">
            </div>
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                ...
                <a href="{{ route('users.create') }}" type="button" class="btn btn-primary">
                    <i class="ki-duotone ki-plus fs-2"></i> Criar Usuário
                </a>
            </div>
        </div>
...
<script>
    const dataTable = $('#datatables-users').DataTable({
        serverSide: true,
        processing: true,
        ajax: {
            url: '{{ route("users.process") }}',
            data: function (data) {
    ...
    $('#users-filters').on('submit', function(e) {
        e.preventDefault();
        dataTable.ajax.reload();
    });

    $('#users-filters').on('reset', function() {
