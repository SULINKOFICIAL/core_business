        ...
        <div class="d-flex flex-stack flex-wrap mb-5">
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                    <form action="" id="modules-categories-filters">
                ...
                <a href="{{ route('modules.categories.create') }}" type="button" class="btn btn-primary">
...
<script>
    const dataTable = $('#datatables-modules-categories').DataTable({
        serverSide: true,
        processing: true,
        ajax: {
            url: '{{ route("modules.categories.process") }}',
            data: function (data) {
    ...
    $('#modules-categories-filters').on('submit', function(e) {
        e.preventDefault();
        dataTable.ajax.reload();
    });

    $('#modules-categories-filters').on('reset', function() {
