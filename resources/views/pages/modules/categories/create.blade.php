...
@section('title', 'Adicionar - Categoria de Módulo')

@section('content')
<p class="text-center fw-bold text-gray-700 fs-2 mb-4 text-uppercase">
    Adicionar Categoria de Módulo
</p>
<form action="{{ route('modules.categories.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-body">
