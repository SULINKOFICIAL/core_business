    ...
    public function formatResults($query)
    {
        ...
        return DataTables::query($query)
            ...
            ->addColumn('actions', function ($row) {
                ...
                $html .= '<div class="menu-item px-3"><a href="' . route('systems.update.supervisor', $row->id) . '" class="menu-link px-3 js-tenant-action-confirm" data-action-label="reiniciar filas" data-tenant-name="' . e($row->name) . '"><i class="fa-solid fa-arrows-rotate me-2"></i>Reiniciar Filas</a></div>';
