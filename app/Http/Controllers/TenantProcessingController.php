        ...
        return DataTables::query($query)
            ...
            ->addColumn('actions', function ($row) {
                ...
                if (app()->environment(['local', 'testing'])) {
                    $html .= '<div class="menu-item px-3"><a href="' . route('systems.remove.packages', $row->id) . '" class="menu-link px-3 js-tenant-action-confirm" data-action-type="remove-packages" data-tenant-id="' . e($row->id) . '" data-action-label="remover pacotes liberados" data-tenant-name="' . e($row->name) . '"><i class="fa-solid fa-box-open me-2"></i>Remover Pacotes</a></div>';
                }
