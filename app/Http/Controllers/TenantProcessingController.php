    ...
    public function formatResults($query)
    {
        ...
        return DataTables::query($query)
            ...
            ->addColumn('actions', function ($row) {
                ...
                $html .= '<div class="menu-item px-3"><a href="' . route('systems.update.database', $row->id) . '" class="menu-link px-3 js-tenant-action-confirm" data-action-type="db" data-action-label="atualizar banco de dados" data-tenant-name="' . e($row->name) . '"><i class="fa-solid fa-database me-2"></i>Atualiza banco de dados</a></div>';
                $html .= '<div class="menu-item px-3"><a href="' . route('systems.update.git', $row->id) . '" class="menu-link px-3 js-tenant-action-confirm" data-action-type="git" data-action-label="atualizar git" data-tenant-name="' . e($row->name) . '"><i class="fa-solid fa-code me-2"></i>Atualiza git</a></div>';
                $html .= '<div class="menu-item px-3"><a href="' . route('systems.update.supervisor', $row->id) . '" class="menu-link px-3 js-tenant-action-confirm" data-action-type="sp" data-action-label="reiniciar filas" data-tenant-name="' . e($row->name) . '"><i class="fa-solid fa-arrows-rotate me-2"></i>Reiniciar Filas</a></div>';
